...
This uses a simple Celsius to Fahrenheit conversion to demon-strate how to effectively work in a team with **_git_** and **_GitHub_**. This is simple by design since we what to show how to use git and GitHub rather than producing a true app.
